...
use Core\Database\Connection\ConnectionInterface;
...
class QueryBuilder
{
    ...
    public function __construct(protected ConnectionInterface $connection, protected Grammar $grammar)
    {
    }
    ...
    public function whereLike($column, $operator = null, $value = null): static
    {
